...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The implementation of the data structure that stores JSON profile.
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The graphical user interface elements used to retrieve user input and their format.
\end{description}

...
Description: The product shall operate on up-to-date versions of Windows, Mac, Linux operating systems with up-to-date versions of Chrome browsers installed that allow JavaScript to run.
Rationale: Target client are users of up-to-date Windows, Mac, Linux operating systems with JavaScript client. 
Fit criterion: The product shall be approved as Windows, Mac, and Linux compliant by the testing group.

Description: The product shall operate with a working and secure internet connection with a download speed above 5 Mbps and an upload speed above 1 Mbps. The desired Internet connection speed is directly proportional to the quantity of data clients require for the testing of their specific web APIs (higher Internet connection speed is desired for applications with higher data traffic).
...
Fit criterion: The product requirements shall be met for users with an Internet connection suitable for allowing web API requests. 

Description: The product shall comply with Canadian federal privacy laws (Privacy Act and Personal Information Protection and Electronic Documents Act) and other relevant legal requirements.
Reference [https://www.priv.gc.ca/en/privacy-topics/privacy-laws-in-canada/]
Rationale: The product should not breach legal requirements in the intended operating environment.
Fit criterion: The product shall be approved as legal compliant by the testing group based on application requirements.

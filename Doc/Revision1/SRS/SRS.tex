...
%------------------------------------------------------------------------------
	...
	\requirement{FR1}{The app shall be able send and receive HTTP messages.}
{\textcolor{red}{In order to communicate information over the internet, the application will use the HTTP protocol.}}
{\textcolor{red}{Messages should be able to be sent and received in less than one second.}}{High}{Dawson Myers}{October 6, 2017}
	\requirement{FR2}{Message format shall strictly follow the REST communication protocol.}
{\textcolor{red}{In order to simplify communication, the application will utilize the REST architectural style.}}
{\textcolor{red}{Every message should follow protocols set forth by the formal REST  architectural style.}}{High}{Brandon Roberts}{October 6, 2017}
	\requirement{FR3}{The app must provide a user interface that allows users to view the content of sent and received messages.}
{\textcolor{red}{In order to maintain high usibility and feature visibility, and allows the user to easily translate goals into actions, the application will provide a user interface that is intuitive to navigate and to view the content of sent and received messages.}}
{\textcolor{red}{More than 3/4 of test users should be able to navigate the web app without further instructions than labels presented on user interface.}}{High}{Yang Liu}{October 6, 2017}
